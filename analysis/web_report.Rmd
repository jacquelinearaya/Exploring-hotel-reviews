...
```{r read_files_hotels, fig.height=2.8, fig.align='center'}
...
```{r hotels_table, fig.height=3, fig.align='center'}
...
```{r read_files_posts, fig.height=3, fig.align='center'}
...
```{r obsbycity, fig.height=3, fig.align='center'}
...
```{r postsbycity, fig.height=3, fig.align='center'}
...
```{r overallhist, fig.height=3, fig.align='center'}
hotels %>%
  filter(!is.na(review_score)) %>%
...
```{r postscountries,  fig.height=3.5, fig.align='center'}
...
```{r hist,fig.height=6, fig.align='center'}
...
```{r starscity, fig.height=3, fig.align='center'}
hotels %>%
...
```{r pscores, fig.height=3, fig.align='center'}
...
```{r postscountries2, fig.height=4.5, fig.align='center'}
#By city
pmeds = posts %>%
  select(city, review_score) %>%  
  group_by(city) %>% 
...
```{r medcountry, fig.height=10, fig.width=7, fig.align='center'}
...
```{r sdcountry, fig.height=9, fig.width=7, fig.align='center'}
...
```{r countrystars, fig.height=8, fig.width=7, fig.align='center'}
...
```{r countrystars2, fig.height=10, fig.width=15, fig.align='center'}
...
```{r conttable, fig.height=5, include=FALSE}
n_cont = posts %>% 
...
```{r contbox, fig.height=3, fig.align='center'}
posts %>% 
...
```{r contdens, fig.height=4, fig.align='center'}
posts %>% 
  select( review_score, review_continent) %>%
  filter(!is.na(review_continent) & review_continent!="Antarctica") %>%
...
```{r contcity, fig.height=6.5, fig.width=7, fig.align='center'}
